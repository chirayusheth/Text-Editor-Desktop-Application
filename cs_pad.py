...
main_application.title("Text Editor by CS")
...
edit.add_command(label = "Clear All", image = clear_all_icon, compound = tk.LEFT, accelerator = "Shift+Ctrl+X", command = lambda : text_editor.delete(1.0, tk.END))
...
# $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ Color Theme Menu Functionality $$$$$$$$$$$$$$$$$$$$$$$$$$
